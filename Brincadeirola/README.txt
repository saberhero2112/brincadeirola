...
This is the readme for Brincadeirola, try to keep it up to date with any information future-you will wish past-you
...
- File > Open > select the top level folder of this project ( i.e. Brincadeirola) > Ok.
...
- To run the project find Brincadeirola.java (which will be in under src/main/java/isaquias/dev) and right click > Run 'Brincadeirola'
